#!/usr/bin/env python3
"""
train_rf.py — Train + validate + export the Random Forest irrigation model

Run this AFTER generate_data.py has created training_data_features.csv.

Usage:
    python3 models/train_rf.py [--data models/training_data_features.csv]
...
def train_model(
    data_path="models/training_data_features.csv",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", default="models/training_data_features.csv",
                        help="Path to feature CSV")
    parser.add_argument("--output", default="models/rf_model.pkl",
